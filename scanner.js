...
window.markOnePrinted = function() {
  ...
  window.renderPrintGrid(); // Met à jour l'onglet impression en arrière-plan
};
...
// 🚨 MODIFICATION : Remplit les DEUX grilles (Nouveaux et Historique)
window.renderPrintGrid = function() {
  ...
  gridPending.innerHTML = pendingHtml || '<div style="grid-column:1/-1; color:var(--mut); font-size:12px; text-align:center; padding:10px;">Tout est imprimé ! 🎉</div>';
