...
window.demoData = {
  ...
  exercices: [
    // ⚡ Cartes COURS / EXO (PC*)
    { id:'PH-AAA', titre:"Théorème énergie cinétique", coursIds:['PH-A1B'], mat:'PHYS', profil:'COURS', question:"Énonce le théorème de l'énergie cinétique (système matériel).", reponse:"ΔEc = ΣW(F_ext) + ΣW(F_int). Référentiel galiléen.", tempsCible:45, priorite:1, statut:'actif', intervalle:0, ease:2.5, repetitions:0, dateProchaineRevision:'2026-01-01', historique:[], epinglee:true, dateCreation:'2026-01-01T08:00:00Z' },
    { id:'PH-BBB', titre:"Rendement Carnot", coursIds:['PH-X9Y'], mat:'PHYS', profil:'FORMULE', question:"Rendement du cycle de Carnot.", reponse:"η = 1 − Tf/Tc (T en Kelvin, Tc>Tf).", tempsCible:30, priorite:2, statut:'actif', intervalle:0, ease:2.5, repetitions:0, dateProchaineRevision:'2026-01-01', historique:[], dateCreation:'2026-01-01T08:00:00Z' },
    { id:'PH-CCC', titre:"Maxwell-Faraday", coursIds:['PH-3K9'], mat:'PHYS', profil:'FORMULE', question:"Équation de Maxwell-Faraday (forme locale).", reponse:"rot(E) = −∂B/∂t", tempsCible:25, priorite:1, statut:'actif', intervalle:0, ease:2.5, repetitions:0, dateProchaineRevision:'2026-01-01', historique:[], dateCreation:'2026-01-01T08:00:00Z' },
    { id:'PH-DDD', titre:"Optique : interférences à 2 ondes", coursIds:['PH-5D4'], mat:'PHYS', profil:'EXO', question:"Calcul de l'interfrange dans le dispositif des fentes d'Young.", reponse:"i = λD/a (D distance fentes-écran, a écartement).", tempsCible:60, priorite:2, statut:'actif', intervalle:0, ease:2.4, repetitions:0, dateProchaineRevision:'2026-01-02', historique:[], dateCreation:'2026-01-01T08:00:00Z' },
    { id:'MA-AAA', titre:"Sous-espace vectoriel", coursIds:['MA-7Z3'], mat:'MATH', profil:'COURS', question:"Définition d'un sous-espace vectoriel.", reponse:"Stable par + et par ·, contient 0_E.", tempsCible:40, priorite:2, statut:'actif', intervalle:0, ease:2.5, repetitions:0, dateProchaineRevision:'2026-01-01', historique:[], dateCreation:'2026-01-01T08:00:00Z' },
    { id:'MA-BBB', titre:"Critère de diagonalisabilité", coursIds:['MA-V6J'], mat:'MATH', profil:'COURS', question:"Critère de diagonalisabilité d'un endomorphisme.", reponse:"⟺ polynôme caractéristique scindé + dim(E_λ) = mult(λ) pour tout λ.", tempsCible:60, priorite:1, statut:'actif', intervalle:0, ease:2.5, repetitions:0, dateProchaineRevision:'2026-01-01', historique:[], dateCreation:'2026-01-01T08:00:00Z' },
    { id:'MA-CCC', titre:"Rayon de convergence Hadamard", coursIds:[], mat:'MATH', profil:'FORMULE', question:"Rayon de convergence d'une série entière (Hadamard).", reponse:"1/R = limsup |a_n|^(1/n)", tempsCible:50, priorite:2, statut:'attente', intervalle:0, ease:2.5, repetitions:0, dateProchaineRevision:null, historique:[], dateCreation:'2026-01-01T08:00:00Z' },
    { id:'MA-DDD', titre:"Série entière dérivée", coursIds:['MA-P4L'], mat:'MATH', profil:'EXO', question:"Calcule la somme de Σn·x^(n-1) sur ]-1,1[.", reponse:"= 1/(1-x)² (dérivée terme à terme de la série géométrique).", tempsCible:90, priorite:2, statut:'actif', intervalle:0, ease:2.4, repetitions:0, dateProchaineRevision:'2026-01-03', historique:[], dateCreation:'2026-01-01T08:00:00Z' },
    { id:'CH-AAA', titre:"Oxydation alcool primaire", coursIds:['CH-T1R'], mat:'CHIM', profil:'COURS', question:"Produits d'oxydation douce d'un alcool primaire.", reponse:"Aldéhyde (puis acide carboxylique si oxydant en excès).", tempsCible:35, priorite:2, statut:'actif', intervalle:0, ease:2.5, repetitions:0, dateProchaineRevision:'2026-01-01', historique:[], dateCreation:'2026-01-01T08:00:00Z' },
    { id:'CH-BBB', titre:"Markovnikov", coursIds:['CH-T1R'], mat:'CHIM', profil:'COURS', question:"Règle de Markovnikov (addition électrophile).", reponse:"H+ s'additionne sur le carbone le plus hydrogéné de la double liaison.", tempsCible:30, priorite:3, statut:'attente', intervalle:0, ease:2.5, repetitions:0, dateProchaineRevision:null, historique:[], dateCreation:'2026-01-01T08:00:00Z' },
    { id:'CH-CCC', titre:"Cinétique ordre 1", coursIds:['CH-8M5'], mat:'CHIM', profil:'FORMULE', question:"Loi de vitesse d'ordre 1 : intégration.", reponse:"[A](t) = [A]₀·exp(−kt) ; t½ = ln2/k.", tempsCible:55, priorite:1, statut:'actif', intervalle:0, ease:2.5, repetitions:0, dateProchaineRevision:'2026-01-01', historique:[], dateCreation:'2026-01-01T08:00:00Z' },
    // 🇬🇧 Cartes ANGLAIS test (atelier rapide)
    { id:'AN-AAA', titre:"to elicit", coursIds:[], mat:'PHYS', profil:'ANGLAIS', question:"to elicit", reponse:"provoquer / susciter (une réaction, une réponse)", tempsCible:15, priorite:2, statut:'actif', intervalle:0, ease:2.3, repetitions:0, dateProchaineRevision:'2026-01-01', historique:[], dateCreation:'2026-01-02T09:00:00Z' },
    { id:'AN-BBB', titre:"to bridge the gap", coursIds:[], mat:'PHYS', profil:'ANGLAIS', question:"to bridge the gap", reponse:"combler le fossé / l'écart", tempsCible:15, priorite:2, statut:'actif', intervalle:0, ease:2.3, repetitions:0, dateProchaineRevision:'2026-01-01', historique:[], dateCreation:'2026-01-02T09:00:00Z' },
    { id:'AN-CCC', titre:"breakthrough", coursIds:[], mat:'PHYS', profil:'ANGLAIS', question:"a breakthrough", reponse:"une percée / une avancée majeure (souvent scientifique)", tempsCible:15, priorite:3, statut:'attente', intervalle:0, ease:2.3, repetitions:0, dateProchaineRevision:null, historique:[], dateCreation:'2026-01-02T09:00:00Z' }
  ],
  devoirs: [
