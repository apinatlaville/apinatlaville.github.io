...
window.demoData = {
  ...
  exercices: (function(){
    ...
    return [
      ...
      // ===========================================================
      { id:'AN-A2C', titre:"to elicit", coursIds:[], mat:'ANGL', profil:'ANGLAIS', question:"to elicit", reponse:"provoquer / susciter (une réaction)", tempsCible:30, priorite:2, statut:'actif', intervalle:0, ease:2.3, repetitions:0, dateProchaineRevision:_today, historique:[], dateCreation:_today },
      ...
      { id:'AN-F4P', titre:"to overcome", coursIds:[], mat:'ANGL', profil:'ANGLAIS', question:"to overcome (an obstacle)", reponse:"surmonter (un obstacle)", tempsCible:30, priorite:2, statut:'actif', intervalle:0, ease:2.3, repetitions:0, dateProchaineRevision:_today, historique:[], dateCreation:_today },

      // ===========================================================
      // 📝 DM UNIQUE (90 min total, à étaler sur 3 sessions)
      // Pas de morceaux séparés : reste UN objet, le système gère la progression
      // ===========================================================
      { id:'MA-DM1', titre:"DM Algèbre linéaire (3 sessions de 30 min)", coursIds:['MA-7Z3','MA-V6J'], mat:'MATH', profil:'EXO', type:'devoir', question:"DM à rendre : 6 exercices d'algèbre linéaire (espaces vectoriels + réduction).", reponse:"", tempsCible:1800, priorite:1, statut:'actif', intervalle:0, ease:2.5, repetitions:0, dateProchaineRevision:_today, dateLimite:_shift(7), historique:[], _morceauxTotal:3, _morceauxFaits:0, _dureeTotaleMin:90, dateCreation:_today }
    ];
  })(),
  devoirs: [
